...
public class DoEditClassifyController implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
		try {
			...
			model.put("action", "finishEditCls.do");
			model.put("actiontype", "edit");
			
			model.put("classifyId", classify.getId());
			model.put("cName", classify.getName());
